...
public class WaterController implements Initializable {
    ...
    @FXML
    private ComboBox WaterBill;
    @FXML
    private AnchorPane form;
    @FXML
    private TextField BillNoTextF;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ObservableList <String> list;
        list = FXCollections.observableArrayList("Dhaka Wasa","Chattogram Wasa","Rajshahi Wasa","Khulna Wasa","Barishal Wasa","Rangpur Wasa");
        WaterBill.setItems(list);
        // TODO
    }    
    ...
    private void Water(ActionEvent event) {
         String water = (String) WaterBill.getValue();
    }
    ...
    private void SendBtnOnAction(ActionEvent event) {
         if(BillNoTextF.getText().equals("") ||ContactNoTextF .getText().equals("")||AmountTextF .getText().equals(""))
        {
                ...
                if(rs.next())
                {
                    double userBal = rs.getDouble("Credit");
                            ...
                            if(userBal>=amount)
                            {
                                ...
                                MobileBanking.Waterprofit+=charge;
