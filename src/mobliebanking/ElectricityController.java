...
public class ElectricityController implements Initializable {
    ...
    @FXML
    private ComboBox Electricity;
    @FXML
    private AnchorPane form;
    @FXML
    private TextField meterNumTextF;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ObservableList <String> list;
        list = FXCollections.observableArrayList("Palli Bidyut","DESCO","NESCO","Westzone");
        Electricity.setItems(list);
    }

    @FXML
    private void electricitybill(ActionEvent event) {
        
        String electricity = (String) Electricity.getValue();
    ...
    private void SendBtnOnAction(ActionEvent event) {
        ...
        if(meterNumTextF.getText().equals("") ||ContactNoTextF .getText().equals("")||AmountTextF .getText().equals(""))
        {
                ...
                if(rs.next())
                {
                    double userBal = rs.getDouble("Credit");
                            ...
                            if(userBal>=amount)
                            {
                                ...
                                MobileBanking.Electricityprofit+=charge;
