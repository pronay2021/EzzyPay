...
public class GasController implements Initializable {
    ...
    @FXML
    private TextField CodeNumTextF;
    @FXML
 ...
 PreparedStatement pst;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ObservableList <String> list;
        list = FXCollections.observableArrayList("Titas Gas","Karnaphuli Gas","JalalBad Gas","Sundarban Gas","Paschimanchal Gas");
        gas.setItems(list);
        // TODO
    }    

    @FXML
    private void gasbill(ActionEvent event) {
         String Gas = (String) gas.getValue();
    }
    ...
    private void SendBtnOnAction(ActionEvent event) {
        if(CodeNumTextF.getText().equals("") ||ContactNoTextF .getText().equals("")||AmountTextF .getText().equals(""))
        {
                ...
                if(rs.next())
                {
                    double userBal = rs.getDouble("Credit");
                            ...
                            if(userBal>=amount)
                            {
                                ...
                                MobileBanking.Gasprofit+=charge;
