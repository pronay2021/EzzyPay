 ...
 PreparedStatement pst;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ObservableList <String> list;
        list = FXCollections.observableArrayList("Link3","Naturalbd","The Introvision","Dot Internet","City Net");
        Internet.setItems(list);
        // TODO
    }    

    @FXML
    private void internetbill(ActionEvent event) {
        String internet = (String) Internet.getValue();
    }
                ...
                if(rs.next())
                {
                    double userBal = rs.getDouble("Credit");
                            ...
                            if(userBal>=amount)
                            {
                                ...
                                MobileBanking.Internetprofit+=charge;
