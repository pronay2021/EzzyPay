...
public class EducationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       ObservableList <String> list;
        list = FXCollections.observableArrayList("AUST","BUET","DU","RUET","KUET","CUET","NDC","Government Science College","Dhaka College","Dhaka City College");
        Education.setItems(list);
        // TODO
    }    

    @FXML
    private void educationbill(ActionEvent event) {
         String educationbill = (String) Education.getValue();
    }
    ...
    private void SendBtnOnAction(ActionEvent event) {
           if(PayIdTextF.getText().equals("") ||ContactNoTextF .getText().equals("")||AmountTextF .getText().equals(""))
        {
                ...
                if(rs.next())
                {
                    double userBal = rs.getDouble("Credit");
                            ...
                            if(userBal>=amount)
                            {
                                ...
                                MobileBanking.Educationprofit+=charge;
